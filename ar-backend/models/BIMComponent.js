...
const BIMComponentSchema = new mongoose.Schema({
  ...
  // Legacy / Assumed schema fields (AI queries)
...
BIMComponentSchema.index({ projectId: 1, category: 1 });
BIMComponentSchema.index({ projectId: 1, level_zone: 1 });
BIMComponentSchema.index({ projectId: 1, element_guid: 1 });

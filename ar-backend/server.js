...
import contractorPerformanceRoutes from './routes/contractorPerformanceRoutes.js';
...
const allowlist = process.env.CORS_ORIGINS
  ...
  : ['http://localhost:5173', 'https://fusionxr-backend-e6e8cgbyh8ghg6fv.malaysiawest-01.azurewebsites.net', 'https://fusionsite360xr.onrender.com', 'https://anselldigitaltwin.onrender.com'];
...
app.use('/api', contractorPerformanceRoutes);
